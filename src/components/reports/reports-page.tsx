              ...
              <TabsContent value="dashboard" className="space-y-6">
                ...
                {ticketReport ? (
                  <div className="space-y-6">
                    ...
                    {ticketReport.slaMetrics && ticketReport.slaMetrics.totalWithSLA > 0 && (
                      <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
                        <CardHeader>
                          ...
                          <CardDescription>
                            Cumplimiento de acuerdos de nivel de servicio y tiempos de respuesta
                          </CardDescription>
                        </CardHeader>
                        <CardContent>
                          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                              <div className="text-3xl font-bold text-green-600 mb-2">
                                {ticketReport.slaMetrics.slaComplianceRate.toFixed(1)}%
                              </div>
                              <div className="text-sm font-medium text-green-700">Cumplimiento SLA</div>
                              <div className="text-xs text-green-600 mt-1">
                                {ticketReport.slaMetrics.slaCompliant} de {ticketReport.slaMetrics.totalWithSLA}
                              </div>
                            </div>
                            <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                              <div className="text-3xl font-bold text-blue-600 mb-2">
                                {ticketReport.slaMetrics.avgSlaResponseTime}
                              </div>
                              <div className="text-sm font-medium text-blue-700">Tiempo Respuesta</div>
                              <div className="text-xs text-blue-600 mt-1">
                                Promedio SLA
                              </div>
                            </div>
                            <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                              <div className="text-3xl font-bold text-red-600 mb-2">
                                {ticketReport.slaMetrics.criticalSlaBreaches}
                              </div>
                            ...
                            <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                              <div className="text-3xl font-bold text-orange-600 mb-2">
                                {ticketReport.slaMetrics.upcomingSlaDeadlines}
                              </div>
                              <div className="text-sm font-medium text-orange-700">En Riesgo</div>
                              <div className="text-xs text-orange-600 mt-1">
                                Próximos a vencer
                              </div>
                            </div>
                          ...
                          <div className="mt-6">
                            <h4 className="text-sm font-medium text-gray-700 mb-3">Cumplimiento SLA por Prioridad</h4>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                              {Object.entries(ticketReport.slaMetrics.slaByPriority).map(([priority, data]) => (
