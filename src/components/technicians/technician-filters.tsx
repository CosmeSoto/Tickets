        ...
        <div className='space-y-4'>
          ...
          {mode === 'technicians' ? (
                ...
                {TECHNICIAN_STATUS_FILTER_OPTIONS.map(option => {
                  ...
                  return (
                    <Button
                      ...
                      size='sm'
                      onClick={() =>
                        (props as TechnicianFiltersProps).setStatusFilter(
                          option.value as TechnicianStatus
                        )
                      }
                      disabled={loading}
                    >
            ...
            <div className='flex flex-wrap gap-2'>
              ...
              <Button
                variant={
                  (props as TechnicianTicketFiltersProps).statusFilter === 'OPEN'
                    ? 'default'
                    : 'outline'
                }
                size='sm'
              ...
              <Button
                variant={
                  (props as TechnicianTicketFiltersProps).statusFilter === 'IN_PROGRESS'
                    ? 'default'
                    : 'outline'
                }
                size='sm'
                onClick={() =>
                  (props as TechnicianTicketFiltersProps).setStatusFilter('IN_PROGRESS')
                }
              ...
              <Button
                variant={
                  (props as TechnicianTicketFiltersProps).statusFilter === 'RESOLVED'
                    ? 'default'
                    : 'outline'
                }
                size='sm'
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3'>
              ...
              <div className='space-y-1'>
                ...
                <Select
                  ...
                  onValueChange={value =>
                    (props as TechnicianFiltersProps).setStatusFilter(value as TechnicianStatus)
                  }
                  disabled={loading}
                >
                  <SelectTrigger>
                  ...
                  <div className='flex flex-wrap gap-2'>
                    {(props as TechnicianTicketFiltersProps).statusFilter !== 'all' && (
                      <Badge variant='secondary' className='text-xs'>
                        ...
                        {
                          STATUS_OPTIONS.find(
                            o => o.value === (props as TechnicianTicketFiltersProps).statusFilter
                          )?.label
                        }
                      </Badge>
                    )}
                      ...
                      <Badge variant='secondary' className='text-xs'>
                        Prioridad:{' '}
                        {
                          PRIORITY_OPTIONS.find(
                            o => o.value === (props as TechnicianTicketFiltersProps).priorityFilter
                          )?.label
                        }
                      </Badge>
                    )}
                    {(props as TechnicianTicketFiltersProps).categoryFilter !== 'all' && (
                      <Badge variant='secondary' className='text-xs'>
                        Categoría:{' '}
                        {
                          ((props as TechnicianTicketFiltersProps).categories || []).find(
                            c => c.id === (props as TechnicianTicketFiltersProps).categoryFilter
                          )?.name
                        }
                      </Badge>
                    )}
                      ...
                      <Badge variant='secondary' className='text-xs'>
                        Fecha:{' '}
                        {
                          DATE_FILTER_OPTIONS.find(
                            o => o.value === (props as TechnicianTicketFiltersProps).dateFilter
                          )?.label
                        }
                      </Badge>
                    )}
