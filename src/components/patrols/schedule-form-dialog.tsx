        ...
        >
          <div className='space-y-4 py-2 max-h-[72vh] overflow-y-auto pr-2'>
            ...
            {(() => {
              ...
              const routeMins =
                routes.find(r => r.id === form.routeId)?.estimatedDurationMinutes ?? 0
                  ...
                  <Select
                    value={
                      form.repeatIntervalMinutes == null
                        ? 'none'
                        : String(form.repeatIntervalMinutes)
                    }
                    onValueChange={v =>
                      setForm(f => ({
                        ...f,
                    ...
                    <div className='space-y-2 border-t pt-3'>
                      ...
                      {isTooShort && (
                        <div className='flex items-start gap-2 p-3 rounded-lg bg-orange-50 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-800 text-xs text-orange-700 dark:text-orange-300'>
                          ...
                          <span>
                            La ruta estima <strong>{formatDurationMinutes(routeMins)}</strong> pero
                            el horario asignado solo da <strong>{durationLabel}</strong>. El agente
