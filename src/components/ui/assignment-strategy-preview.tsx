...
export function AssignmentStrategyPreview({
      ...
      if (categoryId) {
        ...
        if (parentIds.length > 0) {
          ...
          const response = await fetch(
            `/api/technicians/simulate-assignment?categoryId=${parentId}&simulateLevel=${categoryLevel}`
          )
  ...
  }, [categoryId, categoryLevel, hierarchyPath]) // eslint-disable-line react-hooks/exhaustive-deps
              ...
              {preview.selectedTechnician ? (
                  ...
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center space-x-2'>
                      ...
                      <div className='text-sm'>
                        ...
                        <div className='text-xs text-green-700'>{preview.reason}</div>
                      </div>
                    </div>
                ...
                <div className='bg-yellow-50 border border-yellow-200 rounded p-3'>
                  <div className='flex items-center space-x-2'>
                    ...
                    <div className='text-sm'>
                      <div className='font-medium text-yellow-900'>Sin técnicos disponibles</div>
