...
export function TechnicianSelector({
  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
    ...
    switch (e.key) {
      case 'ArrowDown':
        e.preventDefault()
        setHighlightedIndex(prev => (prev < filteredTechnicians.length - 1 ? prev + 1 : prev))
        break
      case 'ArrowUp':
        e.preventDefault()
              ...
              >
                ...
                <div className='flex items-center space-x-2'>
                  ...
                  <Button
                    ...
                    title={
                      tech.autoAssign ? 'Desactivar auto-asignación' : 'Activar auto-asignación'
                    }
                    disabled={disabled}
                  >
              ...
              {filteredTechnicians.length > 0 ? (
                filteredTechnicians.map((technician, index) => (
                  ...
                  >
                    ...
                    <div className='flex-1 min-w-0'>
                      ...
                      {technician.technicianFamilyAssignments &&
                        technician.technicianFamilyAssignments.length > 0 && (
                ...
                <div className='px-3 py-3 text-sm text-muted-foreground text-center'>
                  {searchTerm
                    ...
                    : 'No hay técnicos disponibles para esta familia.'}
                </div>
              )}
            </div>
          </div>
