...
export function TechnicianAssignmentsModal({
  ...
  }, [isOpen, technicianId]) // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        className='max-w-4xl max-h-[90vh] overflow-hidden flex flex-col sm:max-w-[95vw]'
                      ...
                      <Card>
                        <CardContent className='p-4'>
                          <div className='flex items-center space-x-2'>
                            ...
                            <div>
                              <div className='text-2xl font-bold text-green-600'>
                                {stats.performance.resolvedThisMonth}
                              </div>
                              <div className='text-xs text-muted-foreground'>
                                Resueltos Este Mes
                              </div>
                      ...
                      <Card>
                        <CardContent className='p-4'>
                          <div className='flex items-center space-x-2'>
                            ...
                            <div>
                              <div className='text-2xl font-bold text-purple-600'>
                                {stats.performance.totalResolved}
                              </div>
                            ...
                            <div className='flex items-start space-x-3 flex-1 min-w-0'>
                              ...
                              <div className='flex-1 min-w-0'>
                                <div className='flex items-center space-x-2 mb-2'>
                                  ...
                                  <Badge
                                    className={cn('text-xs', getPriorityColor(assignment.priority))}
                                  >
                                ...
                                <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
                                  <div>
                                    ...
                                    <div className='font-medium'>
                                      {assignment.maxTickets} tickets
                                    </div>
                                  </div>
                                  <div>
                                    <div className='text-muted-foreground'>Actuales</div>
                                    <div className='font-medium'>
                                      {assignment.currentTickets || 0} tickets
                                    </div>
                                  </div>
                                  <div>
