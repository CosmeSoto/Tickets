        ...
        >
          <DialogHeader>
            ...
            <DialogDescription className='flex items-center justify-between'>
              <span>
                Todos los usuarios con acceso de gestión de inventario y sus familias asignadas.
                Para activar el permiso a un usuario, ve a Usuarios.
              </span>
              <Button
                variant='ghost'
                size='sm'
              ...
              <div className='text-center py-10 text-muted-foreground'>
                ...
                {!search && (
                  <p className='text-xs mt-1'>
                    ...
                    <span className='font-medium'>&quot;Gestores de Inventario&quot;</span> de esta
                    familia. Al asignarlo, obtendrá acceso automáticamente.
                  </p>
                )}
              </div>
            ) : (
