    ...
    defaultValues: equipment
      ? {
          ...
          warrantyExpiration: equipment.warrantyExpiration
            ? new Date(equipment.warrantyExpiration)
            : undefined,
          ...
          rentalStartDate: equipment.rentalStartDate
            ? new Date(equipment.rentalStartDate)
            : undefined,
    ...
    >
        ...
        <CardContent className='space-y-4'>
          <div className='grid gap-4 md:grid-cols-2'>
            <div className='space-y-2'>
              ...
              <Input id='code' {...register('code')} placeholder='LAP-001' disabled={isEditing} />
                ...
                <div className='flex gap-2'>
                  <div className='flex-1'>
                    <Combobox
                      ...
                      value={watch('typeId') || ''}
                      onValueChange={value =>
                        setValue('typeId', value as any, { shouldValidate: true })
                      }
            ...
            <div className='space-y-2'>
              ...
              {isAssignedStatus ? (
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent side='bottom' className='max-w-xs'>
                      No se puede cambiar el departamento mientras el equipo tiene una asignación
                      activa
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
                ...
                <Select
                  ...
                  onValueChange={value =>
                    setValue('departmentId', value as any, { shouldValidate: true })
                  }
                >
                  <SelectTrigger>
                    <SelectValue
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Información adicional sobre el equipo</CardDescription>
        </CardHeader>
        <CardContent>
          <Textarea
            {...register('notes')}
            ...
            rows={4}
          />
          {errors.notes && <p className='mt-2 text-sm text-destructive'>{errors.notes.message}</p>}
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader className='pb-3'>
          ...
          <CardDescription className='text-xs'>
            {isEditing
              ? 'Gestiona imágenes y documentos del equipo.'
              : `Se subirán al guardar. Máx. ${maxFileSize}MB por archivo.`}
          </CardDescription>
        </CardHeader>
