...
export function EquipmentDetail({ equipmentId, userRole, userId }: EquipmentDetailProps) {
  ...
  const canManage =
    userRole === 'ADMIN' || userRole === 'TECHNICIAN' || (data as any)?.canManageInventory
  ...
  const hasActiveMaintenance =
    isInMaintenance ||
    (maintenanceRecords &&
      maintenanceRecords.some((r: any) =>
        ['REQUESTED', 'SCHEDULED', 'ACCEPTED'].includes(r.status)
      ))
  ...
  return (
    <div className='space-y-6'>
      ...
      {!isInMaintenance &&
        maintenanceRecords &&
        maintenanceRecords.some((r: any) => r.status === 'REQUESTED') && (
          ...
          <div className='space-y-4 py-2'>
            ...
            <div className='space-y-2'>
              ...
              <Select
                ...
                onValueChange={v => setAssignForm(prev => ({ ...prev, assignmentType: v as any }))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            {(assignForm.assignmentType === 'TEMPORARY' ||
              assignForm.assignmentType === 'LOAN') && (
              <div className='space-y-2'>
            ...
            <div className='space-y-2'>
              ...
              <Textarea
                ...
                onChange={e => setAssignForm(prev => ({ ...prev, observations: e.target.value }))}
        ...
        <DialogContent aria-describedby={undefined}>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className='font-semibold'>{equipment.code}</span>.
              {currentAssignment && (
            ...
            <DialogDescription>
              ...
              {(equipment.type as any)?.family?.name && (
                <span className='block mt-1 text-xs text-muted-foreground'>
                  Familia:{' '}
                  <span className='font-medium'>{(equipment.type as any).family.name}</span>
          ...
          <div className='space-y-4 py-2'>
            <div className='space-y-2'>
              ...
              <Select
                ...
                onValueChange={v => setMaintenanceForm(prev => ({ ...prev, type: v as any }))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className='space-y-2'>
              ...
              <Input
                ...
                onChange={e =>
                  setMaintenanceForm(prev => ({ ...prev, scheduledDate: e.target.value }))
                }
              />
            </div>
          </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription asChild>
              <div className='space-y-2'>
                <p>
                  ¿Confirmas que el equipo <span className='font-semibold'>{equipment.code}</span> (
                  {equipment.brand} {equipment.model}) ya no está en uso y debe darse de baja?
                </p>
                <p className='text-sm text-muted-foreground'>
                  El estado cambiará a <span className='font-medium'>Retirado</span>. El equipo
                  dejará de aparecer como activo en el inventario. Podrás eliminarlo definitivamente
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription asChild>
              <div className='space-y-3'>
                <p>
                  Esta acción es{' '}
                  <span className='font-semibold text-destructive'>irreversible</span>. Se eliminará
                  el equipo <span className='font-semibold'>{equipment.code}</span> y todos sus
                  registros asociados (mantenimientos, asignaciones) de forma permanente.
                </p>
            ...
            <Card>
              ...
              <CardContent className='space-y-2'>
                <div>
                  ...
                  <p className='text-xs text-muted-foreground'>
                    {currentAssignment.receiver?.email}
                  </p>
                </div>
                <div>
                  <label className='text-sm font-medium text-muted-foreground'>
          ...
          <CardContent>
            <div className='space-y-3'>
              {maintenanceRecords.map((record: any) => {
                const isActive =
                  equipment.status === 'MAINTENANCE' && record === maintenanceRecords[0]
                  ...
                  >
                    <div className='space-y-1'>
                      <div className='flex items-center gap-2'>
                        ...
                        {record.status && (
                          <Badge
                            className={`text-xs ${statusBadge[record.status] || 'bg-muted text-muted-foreground'}`}
                          >
