    ...
    <div className='space-y-6'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Gestiona las cuentas OAuth vinculadas a este usuario</CardDescription>
        </CardHeader>
        <CardContent>
          {accounts.length > 0 ? (
                  ...
                  >
                    <div className='flex items-center space-x-4'>
                      <Avatar className='h-12 w-12'>
                        ...
                        />
                        <AvatarFallback className='bg-muted'>{provider.icon}</AvatarFallback>
                      </Avatar>
      ...
      {canModify && unlinkedProviders.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Conecta cuentas adicionales para facilitar el acceso</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <AlertDialog open={!!unlinkingAccount} onOpenChange={() => setUnlinkingAccount(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta acción desvinculará la cuenta OAuth seleccionada. El usuario ya no podrá iniciar
              sesión usando esta cuenta, pero mantendrá acceso con su contraseña.
              <div className='mt-3 p-3 bg-muted rounded text-sm'>
                <strong>Nota:</strong> Esta acción no se puede deshacer. Para volver a vincular la
                cuenta será necesario repetir el proceso de autorización.
              </div>
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
