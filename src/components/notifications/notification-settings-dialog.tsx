              ...
              <div className='flex items-start space-x-3'>
                ...
                <div className='space-y-1'>
                  ...
                  <p className='text-xs text-blue-700 dark:text-blue-300'>
                    ...
                    Puedes personalizar qué tipos de eventos quieres recibir y cómo quieres ser
                    notificado.
                  </p>
                  <p className='text-xs text-blue-700 dark:text-blue-300 mt-2'>
                    Los horarios silenciosos solo afectan las notificaciones push y sonidos, pero
                    seguirás recibiendo emails para eventos críticos.
                  </p>
                </div>
              </div>
            </CardContent>
