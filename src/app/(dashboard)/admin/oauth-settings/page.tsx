...
export default function OAuthSettingsPage() {
  ...
  const isBootLoading = status === 'loading' || loading

  useSyncDashboardPageMeta({
    title: 'Configuración OAuth',
    subtitle: isBootLoading
      ? 'Cargando configuración...'
      : 'Gestiona los proveedores de autenticación externa',
  })
  ...
  return (
    <div className='space-y-6'>
      ...
      <Alert>
        ...
        <AlertDescription>
          Configura Google y Microsoft OAuth para permitir que los usuarios se registren con sus
          cuentas. Los usuarios registrados mediante OAuth serán creados automáticamente con rol de{' '}
          ...
          <div className='space-y-2'>
            ...
            <div className='flex space-x-2'>
              ...
              <Button
                ...
                size='sm'
                onClick={() =>
                  copyToClipboard(`${baseUrl}/api/auth/callback/google`, 'google-redirect')
                }
              >
          ...
          <div className='space-y-2'>
            ...
            <div className='relative'>
              ...
              <Button
                ...
                onClick={() =>
                  setGoogleConfig({ ...googleConfig, showSecret: !googleConfig.showSecret })
                }
              >
                {googleConfig.showSecret ? (
        ...
        <CardContent className='space-y-4'>
          ...
          <div className='space-y-2'>
            ...
            <div className='flex space-x-2'>
              ...
              <Button
                ...
                size='sm'
                onClick={() =>
                  copyToClipboard(`${baseUrl}/api/auth/callback/azure-ad`, 'microsoft-redirect')
                }
              >
                {copiedField === 'microsoft-redirect' ? (
                  <Check className='h-4 w-4' />
                ) : (
                  <Copy className='h-4 w-4' />
                )}
            ...
            <div className='relative'>
              ...
              <Button
                ...
                onClick={() =>
                  setMicrosoftConfig({
                    ...microsoftConfig,
                    showSecret: !microsoftConfig.showSecret,
                  })
                }
              >
                {microsoftConfig.showSecret ? (
                  <EyeOff className='h-4 w-4' />
                ) : (
                  <Eye className='h-4 w-4' />
                )}
          ...
          <div className='flex items-center space-x-3'>
            <input
              ...
              onChange={e =>
                setMicrosoftConfig({ ...microsoftConfig, isEnabled: e.target.checked })
              }
              className='h-4 w-4 rounded border-border'
            />
      ...
      <Card className='bg-blue-50 border-blue-200'>
        ...
        <CardContent className='text-sm text-blue-800 space-y-2'>
          ...
          <p className='mt-4'>
            ...
            <code className='bg-blue-100 px-2 py-1 rounded'>OAUTH_SETUP_GUIDE.md</code>
          </p>
        </CardContent>
      </Card>
    </div>
