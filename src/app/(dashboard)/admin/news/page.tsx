...
import { FileDropZone as NewsAttachmentsUploader } from '@/components/common/file-drop-zone'
import type { PendingFile, UploadedAttachment } from '@/components/common/file-drop-zone'
