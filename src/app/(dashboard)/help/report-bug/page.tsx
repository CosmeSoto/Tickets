...
import { Bug, Send, AlertTriangle, Info, Upload, X } from 'lucide-react'
            ...
            <div className='flex items-start space-x-3'>
              ...
              <div>
                ...
                <p className='text-sm text-blue-700 mt-1'>
                  Proporciona la mayor cantidad de detalles posible para ayudarnos a reproducir y
                  solucionar el problema más rápidamente.
                </p>
              </div>
            </div>
          </CardContent>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      {[
                        ...
                        },
                        {
                          ...
                          desc: 'Afecta funcionalidad',
                        },
                        {
                          value: 'HIGH',
                          label: 'Alta',
                          color: 'bg-orange-100 text-orange-800',
                          desc: 'Bloquea trabajo',
                        },
                        {
                          value: 'CRITICAL',
                          label: 'Crítica',
                          color: 'bg-red-100 text-red-800',
                          desc: 'Sistema no funciona',
                        },
                      ].map(severity => (
                        <Button
                          key={severity.value}
              ...
              <CardContent className='space-y-3 text-sm'>
                <div>
                  ...
                  <p className='text-muted-foreground'>
                    Incluye detalles exactos sobre lo que estabas haciendo cuando ocurrió el
                    problema.
                  </p>
                </div>
                <div>
                  ...
                  <p className='text-muted-foreground'>
                    Las imágenes ayudan mucho a entender el problema visualmente.
                  </p>
                </div>
                <div>
                  <h4 className='font-medium mb-1'>Incluye mensajes de error</h4>
                  <p className='text-muted-foreground'>
                    Copia y pega cualquier mensaje de error exactamente como aparece.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className='space-y-3 text-sm'>
                <div className='p-2 bg-yellow-50 border border-yellow-200 rounded'>
                  ...
                  <p className='text-yellow-700 text-xs mt-1'>
                    Estamos trabajando en optimizar la subida de archivos grandes.
                  </p>
                </div>
                <div className='p-2 bg-blue-50 border border-blue-200 rounded'>
                  <h4 className='font-medium text-blue-800'>Notificaciones en Safari</h4>
                  <p className='text-blue-700 text-xs mt-1'>
                    Las notificaciones push pueden no funcionar correctamente en Safari.
                  </p>
                </div>
              </CardContent>
            </Card>
