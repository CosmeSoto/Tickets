      ...
      <div className='bg-card border border-border rounded-2xl p-8 space-y-6'>
        ...
        <div className='space-y-6 text-sm text-muted-foreground'>
          <section className='space-y-2'>
            ...
            <p>
              Al acceder y utilizar este sistema de tickets, usted acepta estar sujeto a estos
          ...
          <section className='space-y-2'>
            ...
            <p>
              Este sistema está diseñado para la gestión de tickets de soporte técnico. Los usuarios
              se comprometen a:
            </p>
          ...
          <section className='space-y-2'>
            ...
            <p>
              Los usuarios son responsables de mantener la seguridad de su cuenta y de todas las
          ...
          <section className='space-y-2'>
            ...
            <p>
              ...
              nos hacemos responsables de daños directos, indirectos, incidentales o consecuentes.
            </p>
          </section>
          ...
          <section className='space-y-2'>
            ...
            <p>
              Si tiene preguntas sobre estos términos, puede contactarnos a través del sistema de
              tickets.
            </p>
          </section>
        </div>
