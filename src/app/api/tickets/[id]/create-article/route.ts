    ...
    await prisma.audit_logs.create({
      data: {
        ...
        details: {
          ...
          sourceTicketDepartment: ticket.categories?.departments?.name,
          ...
          hasResolutionPlan: ticket.resolution_plans && ticket.resolution_plans.length > 0,
          hasRating: !!ticket.ticket_ratings,
