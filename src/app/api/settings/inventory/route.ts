...
const inventorySettingsSchema = z
  .object({
    ...
    license_payment_alert_enabled: z.boolean().optional(),
    license_payment_alert_days_first: z.number().min(1).max(90).optional(),
    license_payment_alert_days_second: z.number().min(1).max(90).optional(),
...
const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  license_payment_alert_enabled: 'true',
  license_payment_alert_days_first: '30',
  license_payment_alert_days_second: '7',
...
const NUMBER_FIELDS = [
  ...
  'license_payment_alert_days_first',
  'license_payment_alert_days_second',
...
function getSettingDescription(key: string): string {
  const descriptions: Record<string, string> = {
    ...
    license_payment_alert_enabled:
      'Habilita alertas de pago próximo para licencias sin contrato vinculado',
    license_payment_alert_days_first: 'Días antes para primera alerta de pago de licencias',
    license_payment_alert_days_second: 'Días antes para segunda alerta de pago de licencias',
