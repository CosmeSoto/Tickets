/**
 * POST /api/inventory/equipment/invoices/[invoiceId]/convert-to-schedule —
 * convierte una factura de pago único (sin abonos) en un plan de cuotas —
 * ver EquipmentInvoiceService.convertToSchedule.
 */
...
export async function POST(
  ...
  try {
    ...
    const invoices = await EquipmentInvoiceService.convertToSchedule(
      invoiceId,
      {
    ...
    console.error('[POST /equipment/invoices/[id]/convert-to-schedule]', error)
