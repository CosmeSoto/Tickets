/**
 * GET    /api/inventory/licenses/invoices/[invoiceId] — obtiene una factura
 * PATCH  /api/inventory/licenses/invoices/[invoiceId] — actualiza
 * DELETE /api/inventory/licenses/invoices/[invoiceId] — elimina
 */
...
export async function GET(
  ...
  try {
    ...
    console.error('[GET /licenses/invoices/[id]]', error)
...
export async function PATCH(
  ...
  try {
    ...
    if (body.action === 'markAsPaid') {
      ...
      const invoice = await LicenseInvoiceService.markAsPaid(
        invoiceId,
        {
    ...
    const invoice = await LicenseInvoiceService.update(
      invoiceId,
      {
        invoiceNumber,
        purchaseOrderNumber,
    ...
    console.error('[PATCH /licenses/invoices/[id]]', error)
...
export async function DELETE(
  ...
  try {
    ...
    await LicenseInvoiceService.delete(invoiceId, session.user.id)
    return NextResponse.json({ ok: true })
  } catch (error) {
    console.error('[DELETE /licenses/invoices/[id]]', error)
    return NextResponse.json(
