...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (searchParams.get('includeRecommendations'))
      queryData.includeRecommendations = searchParams.get('includeRecommendations') === 'true'
    if (searchParams.get('includePatterns'))
      queryData.includePatterns = searchParams.get('includePatterns') === 'true'
 ...
 */
async function handleTogglePattern(
  patternId: string,
  enabled: boolean,
  userId: string,
  startTime: number
