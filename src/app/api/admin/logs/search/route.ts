...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (searchParams.get('components'))
      queryData.components = searchParams.get('components')?.split(',')
    if (searchParams.get('operations'))
      queryData.operations = searchParams.get('operations')?.split(',')
