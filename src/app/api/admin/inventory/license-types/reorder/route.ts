/**
 * PATCH /api/admin/inventory/license-types/reorder
 * Body: { ids: string[] }
 */
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    return persistCatalogOrder('license_types', parsed.data.ids)
  } catch (error) {
    console.error('[PATCH license-types/reorder]', error)
