/**
 * PATCH /api/admin/inventory/equipment-types/reorder
 * Body: { ids: string[] }
 */
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    return persistCatalogOrder('equipment_types', parsed.data.ids)
  } catch (error) {
    console.error('[PATCH equipment-types/reorder]', error)
