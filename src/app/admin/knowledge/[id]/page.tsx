...
import { ArrowLeft, Eye, Calendar, User, Tag, BookOpen, Share2, Trash2, CheckCircle, XCircle } from 'lucide-react'
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-muted-foreground">
                        Este artículo no está publicado
                      </span>
                    </div>
                    <TooltipProvider>
                      <Tooltip>
              ...
              <Card>
                ...
                <CardContent>
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Link href={`/admin/tickets/${article.sourceTicket.id}`}>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  {similarArticles.map((similar) => (
                    <Link
                      key={similar.id}
                      href={`/admin/knowledge/${similar.id}`}
                      className="block"
                    >
