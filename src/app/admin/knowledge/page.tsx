...
import { BookOpen, Eye, ThumbsUp, FileText, Lightbulb, AlertTriangle } from 'lucide-react'
    ...
    try {
      ...
      if (res.ok) {
        toast({
          ...
          description: `"${articleToDelete.title}" fue eliminado`,
        })
        reload()
      } else {
      ...
      <div className='space-y-6'>
            ...
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='text-sm text-blue-700 dark:text-blue-300 mt-1'>
                  Como administrador ves todos los artículos de todas las áreas. Puedes filtrar por
                  área, categoría o autor. Los artículos se crean desde tickets resueltos.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
          ...
          <SymmetricStatsCard
            ...
            color='yellow'
            status={
              stats.avgHelpful >= 80 ? 'success' : stats.avgHelpful >= 60 ? 'normal' : 'warning'
            }
          />
        </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              deshacer y eliminará también todos los votos asociados.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
