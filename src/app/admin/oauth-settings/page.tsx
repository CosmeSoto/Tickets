  ...
  if (status === 'loading' || loading) {
    return (
      <RoleDashboardLayout
        ...
        subtitle='Gestión de proveedores de autenticación'
      >
      ...
      <div className='space-y-6'>
        ...
        <Alert>
          ...
          <AlertDescription>
            ...
            cuentas. Los usuarios registrados mediante OAuth serán creados automáticamente con rol
            de <strong>CLIENT</strong>.
          </AlertDescription>
        </Alert>
