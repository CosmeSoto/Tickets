...
export default function TechniciansPage() {
  ...
  return (
    ...
    >
      ...
      {/* Panel de asignación de familias — componente compartido */}
      <Dialog
        open={familyPanelState.open}
        onOpenChange={(open) => {
          if (!open) setFamilyPanelState({ open: false, technicianId: '', technicianName: '' })
        }}
      >
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>Familias de {familyPanelState.technicianName}</DialogTitle>
            <DialogDescription>Asigna o desasigna familias para este técnico</DialogDescription>
          </DialogHeader>
          {familyPanelState.technicianId && (
