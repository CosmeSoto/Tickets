...
import { ExecutiveSummaryTab, TechniciansTab } from '@/components/reports/tabs'
      ...
      <div className='space-y-6'>
        ...
        >
          ...
          <TabsContent value='trends'>
            <Card>
              <CardContent className='py-12 text-center'>
                <p className='text-muted-foreground'>TrendsTab - En desarrollo</p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value='sla'>
            <Card>
              <CardContent className='py-12 text-center'>
                <p className='text-muted-foreground'>SLATab - En desarrollo</p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value='satisfaction'>
            <Card>
              <CardContent className='py-12 text-center'>
                <p className='text-muted-foreground'>SatisfactionTab - En desarrollo</p>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
