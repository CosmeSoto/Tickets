              ...
              <div>
                ...
                {deletingBackup && (
                  <div className='mt-3 p-3 bg-muted rounded text-sm'>
                    ...
                    <div>
                      • Estado:{' '}
                      {deletingBackup.status === 'completed'
                        ? 'Completado'
                        : deletingBackup.status === 'failed'
                          ? 'Fallido'
                          : 'En progreso'}
                    </div>
            ...
            <AlertDialogDescription asChild>
              <div>
                ...
                <div className='mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded text-sm'>
                  ...
                  <div className='text-yellow-700'>• Archivos físicos (si existen)</div>
                  <div className='text-yellow-700'>• Registros de base de datos</div>
                </div>
                <p className='mt-2 text-red-600 font-medium'>Esta acción no se puede deshacer.</p>
              </div>
            </AlertDialogDescription>
