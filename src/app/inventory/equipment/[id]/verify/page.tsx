...
export default function EquipmentVerifyPage({ params }: PageProps) {
  ...
  const conditionColor: Record<string, string> = {
    ...
    LIKE_NEW: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300',
          ...
          <CardContent className='p-5 space-y-4'>
            ...
            <div className='grid grid-cols-2 gap-3'>
              ...
              <div className='space-y-1'>
                ...
                <span
                  className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${statusColor[equipment.status] ?? 'bg-gray-100 text-gray-800'}`}
                >
              ...
              <div className='space-y-1'>
                ...
                <span
                  className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${conditionColor[equipment.condition] ?? 'bg-gray-100 text-gray-800'}`}
                >
