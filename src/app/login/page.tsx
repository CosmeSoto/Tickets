        ...
        <CardContent className="pb-8">
          ...
          <div className='mt-8 p-4 bg-muted rounded-lg border border-border'>
            <div className='text-sm text-muted-foreground'>
              <p className='mb-3 font-medium text-foreground flex items-center'>
              ...
              <div className='space-y-2 text-xs'>
                <div className="flex items-center justify-between p-2 bg-card rounded border">
                  <div>
                    ...
                    <span className="ml-2">admin@tickets.com</span>
                  </div>
                  <span className="text-muted-foreground">admin123</span>
                </div>
                <div className="flex items-center justify-between p-2 bg-card rounded border">
                  <div>
                    <span className="font-medium text-purple-600">Técnico:</span>
                    <span className="ml-2">tecnico1@tickets.com</span>
                  </div>
                  <span className="text-muted-foreground">tech123</span>
                </div>
                <div className="flex items-center justify-between p-2 bg-card rounded border">
                  <div>
                    <span className="font-medium text-green-600">Cliente:</span>
                    <span className="ml-2">cliente1@empresa.com</span>
                  </div>
                  <span className="text-muted-foreground">client123</span>
                </div>
              </div>
            </div>
          </div>
