  ...
  return (
    <Card className='w-full'>
      <CardHeader>
        ...
        <p className='text-sm text-muted-foreground'>Tus categorías más utilizadas recientemente</p>
      </CardHeader>
      <CardContent>
        {isLoading && (
                  ...
                  <div className='flex-1 min-w-0'>
                    ...
                    <div className='flex items-center gap-2 mb-1'>
                      <span
                        ...
                        aria-hidden='true'
                      />
                      <h4 className='font-semibold text-sm truncate'>{frequent.category.name}</h4>
                    </div>
