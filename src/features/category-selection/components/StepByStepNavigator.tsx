...
export function StepByStepNavigator({
  ...
  const getLevelTitle = (level: number): string => {
    const titles = ['Categoría Principal', 'Subcategoría', 'Especialidad', 'Detalle']
    ...
    <Card className='w-full'>
      <CardHeader>
        <div className='flex items-center justify-between mb-2'>
          ...
          <Badge variant='outline'>{getLevelTitle(currentLevel)}</Badge>
        </div>
      ...
      <CardContent className='space-y-4'>
        ...
        {selectedPath.length > 0 && (
          <div className='pt-4 border-t'>
            <p className='text-xs text-muted-foreground mb-2'>Ruta seleccionada:</p>
