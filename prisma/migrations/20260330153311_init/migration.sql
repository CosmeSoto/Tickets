...
CREATE TABLE "landing_page_content" (
    "id" TEXT NOT NULL,
    "hero_title" TEXT NOT NULL DEFAULT 'Gestión Integral de Operaciones',
    "hero_subtitle" TEXT NOT NULL DEFAULT 'Tickets, inventario, rondas en una sola plataforma',
    ...
    "company_tagline" TEXT NOT NULL DEFAULT 'Gestión Integral de Operaciones',
    ...
    "meta_title" TEXT NOT NULL DEFAULT 'Sistema de Tickets - Gestión Integral de Operaciones',
