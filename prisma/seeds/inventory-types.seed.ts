...
export async function seedLicenseTypes(prisma: PrismaClient, familyMap: Map<string, string>) {
  ...
  const types = [
    ...
    {
      code: 'OFFICE_365',
      name: 'Microsoft 365 Básico',
      icon: 'FileText',
      order: 2,
      familyId: fam('ADMINISTRATIVE'),
    },
    {
      code: 'OFFICE_365_BUSINESS_PREMIUM',
    ...
    {
      code: 'OFFICE_365_POWER_BI',
      name: 'Microsoft 365 Business Premium + Power BI',
      icon: 'FileText',
      order: 4,
      familyId: fam('ADMINISTRATIVE'),
    },
    ...
    { code: 'ADOBE', name: 'Adobe', icon: 'Paintbrush', order: 6, familyId: fam('ADMINISTRATIVE') },
    { code: 'AUTOCAD', name: 'AutoCAD', icon: 'Ruler', order: 7, familyId: fam('ADMINISTRATIVE') },
    {
    ...
    { code: 'SAAS', name: 'SaaS (Otro)', icon: 'Globe', order: 9, familyId: fam('ADMINISTRATIVE') },
    {
      code: 'SUBSCRIPTION',
      name: 'Suscripción',
      icon: 'RefreshCw',
